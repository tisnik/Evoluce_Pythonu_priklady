...
async def main():
    ...
    await asyncio.gather(
        ...
        asyncio.create_task(task(6, queue)),
        asyncio.create_task(task(7, queue)),
        asyncio.create_task(task(8, queue)),
        asyncio.create_task(task(9, queue)),
        asyncio.create_task(task(10, queue)),
    )
    print("Main finished")
